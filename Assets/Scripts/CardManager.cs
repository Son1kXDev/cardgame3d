...
public struct Card
{
    ...
    public int Attack, Heal, Defense, Manacost;
    ...
    public void GetHeal(int heal) => Defense += heal;
}
...
public class CardManager : MonoBehaviour
{
    private void Awake()
    {
        ...
        CardManagerList.AllCards.Add(new Card("Целитель", "Sprite/Cards/heal_elf", "Sprite/Cards/heal_ork", 1, 5, 3, 5, CardType.Heal)); //хил своим кроме зданий
        CardManagerList.AllCards.Add(new Card("Маг", "Sprite/Cards/wizard_elf", "Sprite/Cards/wizard_ork", 10, 2, 3, 10, CardType.Heal));
        CardManagerList.AllCards.Add(new Card("Катапульта", "Sprite/Cards/catapult_elf", "Sprite/Cards/catapult_ork", 10, 0, 5, 10, CardType.Build)); //баф на здания
