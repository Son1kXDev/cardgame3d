...
public class CardManager : MonoBehaviour
{
    private void Awake()
    {
        CardManagerList.AllCards.Add(new Card("Лучник", "Sprite/Cards/archer", 7, 3, 2, CardType.Attack));
        CardManagerList.AllCards.Add(new Card("Мечник", "Sprite/Cards/melee", 5, 5, 4, CardType.Attack));
        CardManagerList.AllCards.Add(new Card("Танк", "Sprite/Cards/tank", 3, 15, 10, CardType.Attack));
        CardManagerList.AllCards.Add(new Card("Целитель", "Sprite/Cards/heal", 1, 3, 5, CardType.Heal)); //хил своим кроме зданий
        CardManagerList.AllCards.Add(new Card("Маг", "Sprite/Cards/wizard", 10, 3, 10, CardType.Heal));
